...
The sample is intentionally static and contains no sample C# scripts, UGUI, beam volume, custom shadows, post-processing, or runtime animation. Each light illuminates a matching receiver using `Mizot/Virtual Light/Lit`.
